...
@WebServlet("/menuFindByPage")
public class MenuFindByPage extends HttpServlet {
   private MenuService menuService=new MenuServiceImpl();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       //获取总记录数
       int count =menuService.findBySize();
       //设置总记录数
     ...
     //获取当前页
     		...
     		//去数据库分页查询
     		List<Menu> list = menuService.findByPage(pagePresent);
     		//把查询出来的值存入session
