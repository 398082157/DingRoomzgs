...
<div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="${pageContext.request.contextPath }/menuUpdatesave" accept-charset="utf-8" method="post" class="form-horizontal" >    
            <div class="row-fluid">
               <div class="span7">  	
               <input name="id"  id="name" type="hidden" value="${model.id}">
               <input name="pic"  id="pic" type="hidden" value="${model.pic}">
					<div class="control-group">
							<label class="control-label" for="names">菜 名</label>
							<div class="controls">
							<input name="name" class="input-xlarge focused" id="names" type="text" value="${model.name}">
							</div>
					</div>
					<div class="control-group">
							<label class="control-label" for="price">价 格</label>
							<div class="controls">
							<input name="price" class="input-xlarge focused" id="price" type="text" value="${model.price}">
							</div>
					</div>
					<div class="control-group">
					<label class="control-label" >类 型</label>
					<div class="controls">
					<select id="mySelect" name="typeId"  class="selectpicker show-tick"  data-size="4" >
						<c:forEach items="${menutypelist}" var="mtt">
						<c:if test="${model.menuType.id==mtt.id}">
						<option  value="${mtt.id}"  selected="selected">${mtt.name}</option>
						</c:if>
  						<c:if test="${menu.menuType.id!=mtt.id}">
					...
					<input id="menutype" type="hidden"  name="menutype" value="${model.menuType.id}">
					
					<div class="control-group">
							<label class="control-label" for="remark">备 注</label>
							<div class="controls">
							<textarea rows="4" cols="20" name="remark" id="remark">${model.remark}</textarea>
							</div>
					</div>
				...
				<div class="span5">
					<div class="fileupload fileupload-new" data-provides="fileupload">
					  <div class="fileupload-new thumbnail" style="width: 220px; height: 170px;"><img src="${pageContext.request.contextPath }/images/${model.pic}" /></div>
					  ...
					  <input type="file" name="photo" value="${pageContext.request.contextPath }/images/${model.pic}" />
					  </span>
               ...
               <div class="form-actions">
								...
								<a href="${pageContext.request.contextPath }/menuFindByPage?pageNow=${pNow}">
